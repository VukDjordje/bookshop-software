...
public class FrmDodajAutora extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jButtonOdaberiAutora = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);

        jLabelFilter.setText("Filter (po prezimenu) :");
        ...
        jButtonOdaberiAutora.setText("Odaberi autora");
        jButtonOdaberiAutora.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonOdaberiAutoraActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jButtonOdaberiAutora))
    ...
    private void jButtonOdaberiAutoraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonOdaberiAutoraActionPerformed
        ...
        if (red != -1) {
            ...
            FrmDodavanjeKnjige frmProba = (FrmDodavanjeKnjige) getParent();
            frmProba.setAutor(autor);
            dispose();
        } else {
            JOptionPane.showMessageDialog(this, "Morate izabrati autora!", "Odabir autora", JOptionPane.ERROR_MESSAGE);
        }
    }//GEN-LAST:event_jButtonOdaberiAutoraActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmDodajAutora.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmDodajAutora dialog = new FrmDodajAutora(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JButton jButtonOdaberiAutora;
    ...
    private void srediTabelu(String filter) {
        ...
        ArrayList<Autor> listaAutora = (ArrayList<Autor>) odgovor.getOdgovor();
